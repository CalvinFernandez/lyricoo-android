...
/** Handles the playing of a song.
 * Basically acts as a wrapper for the MediaPlayer
 * class to stream a song from a url and 
 * 
 *
 */
public class LyricooPlayer {
	...
	/** Load a song to play by url
	 * 
	 * @param url
	 */
	public LyricooPlayer(String url, MediaPlayer.OnPreparedListener listener){
