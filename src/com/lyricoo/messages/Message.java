...
public class Message extends LyricooModel {
	...
	/**
	 * Message constructor without read boolean defaults to true. Use this if
	 * the message is being sent by the user.
	 * 
	 * @param content
	 * @param userId
	 * @param contactId
	...
	/**
	 * Build a message from an android bundle object
	 * 
	 * @param bundle
	 * @throws MessageException
	 */
	public Message(Bundle bundle) throws MessageException {
		if (bundle.containsKey("user_id") && bundle.containsKey("contact_id")
				&& bundle.containsKey("sent") && bundle.containsKey("content")
	...
	/**
	 * Returns a String containing a readable format for the time this message
	 * was sent. This can be used directly in the layout.
	 * 
	 * @return The message sent time in easy to read form
	 */
	public String getDisplayableTime() {
		return DateUtils.getRelativeTimeSpanString(mTime.getTime()).toString();
	}
	...
	/**
	 * Custom put methods for updating a message Use this if you want to update
	 * the message content.
	 * 
